...
| 版本 | 框架 | 特点 |
|------|------|------|
| **0.0.x** | 纯 Python 命令行 | 此版本通过 Selenium 实现，未公开，且已弃项 |
| **1.0.x** | 纯 Python 命令行 | 无 UI，直接在终端输出检测结果，依赖少，运行快 |
| **2.0.x** | Tkinter 桌面版 | 轻量 GUI，直接下载打开 .exe 文件即可运行 |
| **3.0.x** | PySide 桌面版 | 开发中，已有 Beta 版本 |

> 各版本的详细 README 位于对应版本文件夹中。
